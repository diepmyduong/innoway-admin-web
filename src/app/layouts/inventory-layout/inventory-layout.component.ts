...
export class InventoryLayoutComponent implements OnInit {
  ...
  goToInventoryLayout() {
    this.router.navigate(['/Inventory-layout'], { relativeTo: this.route });
  }

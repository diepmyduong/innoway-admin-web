...
export class CategoryComponent implements OnInit {
  ...
  async getItems() {
    ...
    this.items.next(await this.innowayApi.productCategory.getList({ query }))
    this.itemCount = this.innowayApi.productCategory.pagination.totalItems
  ...
  async deleteItem(item) {
    ...
    try {
      ...
      await this.innowayApi.productCategory.delete(item.id)
  ...
  async deleteAll() {
    ...
    try {
      try { await this.confirmDelete() } catch (err) { return };
      await this.innowayApi.productCategory.deleteAll(ids)

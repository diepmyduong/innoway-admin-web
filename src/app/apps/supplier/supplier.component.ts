...
export class SupplierComponent implements OnInit {
    ...
    ngOnInit() {
      this.subscriptions.onItemsChange = this.innowayApi.supplier.items.subscribe(items => {
    ...
    async getItems() {
      ...
      this.items.next(await this.innowayApi.supplier.getList({ query }))
      this.itemCount = this.innowayApi.supplier.pagination.totalItems
    ...
    async deleteItem(item) {
      ...
      try {
        ...
        await this.innowayApi.supplier.delete(item.id)
    ...
    async deleteAll() {
      ...
      try {
        try { await this.confirmDelete() } catch (err) { return };
        await this.innowayApi.supplier.deleteAll(ids)

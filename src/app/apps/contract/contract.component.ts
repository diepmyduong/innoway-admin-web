...
export class ContractComponent implements OnInit {
  ...
  ngOnInit() {
    this.subscriptions.onItemsChange = this.innowayApi.contract.items.subscribe(items => {
  ...
  async getItems() {
    ...
    this.items.next(await this.innowayApi.contract.getList({ query }))
    this.itemCount = this.innowayApi.contract.pagination.totalItems
  ...
  async deleteItem(item) {
    ...
    try {
      ...
      await this.innowayApi.contract.delete(item.id)
  ...
  async deleteAll() {
    ...
    try {
      try { await this.confirmDelete() } catch (err) { return };
      await this.innowayApi.contract.deleteAll(ids)
